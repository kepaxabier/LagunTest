...
#                                         eu_list.append(l.name())
                                ...
                                print("Ningun synset!!!")
                        print(str(w.index)+"\t"+w.text+"\t"+w.lemma+"\t"+w.upos+"\t"+w.xpos+"\t"+w.feats+"\t"+str(w.governor)+"\t"+str(w.dependency_relation)+"\t"+definition.replace('\n', '')+"\t"+nueve.replace('\n', '')+"\t"+url+"\t"+str(examples)+"\t_")
                        ...
                        syntaxfile.write("%s" % str(w.index)+"\t"+w.text+"\t"+w.lemma+"\t"+w.upos+"\t"+w.xpos+"\t"+w.feats+"\t"+str(w.governor)+"\t"+str(w.dependency_relation[:4])+"\t"+definition.replace('\n', '')+"\t_\t_")
                        estfile.write("%s" % str(w.index)+"\t"+w.text+"\t"+w.lemma+"\t"+w.upos+"\t"+w.xpos+"\t"+w.feats+"\t"+str(w.governor)+"\t"+str(w.dependency_relation[:4])+"\t"+definition.replace('\n', '')+"\t"+nueve.replace('\n', '')+"\t"+url+"\t"+str(examples)+"\t_")
                        syntaxfile.write("\n")
                        estfile.write("\n")
#     syntaxfile.write("\n")
#     estfile.write("\n")
...
class Sentence:
    ...
    def set_ukb_sense(self,language):
        ...
        id=1
        for words in self.word_list:
            if (words.upos=="NOUN" or words.upos=='PROPN' or words.upos=="VERB" or words.upos=="ADJ" or words.upos=='ADV'):
        ...
        if language=='english':
            ...
            os.system("/var/www/html/erraztest/ukb-master/src/ukb_wsd --client --port 10000 " + str(contextname) + " > " + str(ukboutname))
        if language=='basque':
            #os.system("/home/kepa/ukb-master/src/ukb_wsd --client --port 10001 "+ str(contextname) + " > "+str(ukboutname))
            os.system("/var/www/html/erraztest/ukb-master/src/ukb_wsd --client --port 10001 " + str(contextname) + " > " + str(ukboutname))
